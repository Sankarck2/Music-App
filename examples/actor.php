...
$aname=$_POST['actor_name'];

$thumb1=$_POST['thumb'];


  	
	$target_path = $_SERVER["CONTEXT_DOCUMENT_ROOT"]."/examples/uploads/actor/";
...
$targ1="examples/uploads/actor/".basename($_FILES['thumbnail']['name']);
...
$query ="INSERT INTO actor(name, img) VALUES ( '".$aname."','".$targ1."')";
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text"  name="actor_name" value="<?php echo (isset($coursedata['name'])) ? $coursedata['name'] : '';?>">
                                </div>
                            </div>
                        </div>
