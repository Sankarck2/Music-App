...
$thumb1=$_POST['thumb'];
	...
	$target_path = $_SERVER["CONTEXT_DOCUMENT_ROOT"]."/examples/uploads/singer/";
...
$query ="INSERT INTO singer(name, img) VALUES ( '".$aname."','".$targ1."')";
...
WHERE id = '". $_POST['id']."'";
        ...
        header("location: listsinger.php");
...
$sql = "SELECT * FROM singer where id=".$_REQUEST['id'];
$result = $db->query($sql);
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text"  name="singer_name" value="<?php echo (isset($coursedata['name'])) ? $coursedata['name'] : '';?>">
                                </div>
                            </div>
                        </div>
