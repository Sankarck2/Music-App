...
$thumb1=$_POST['thumb'];
	...
	$target_path = $_SERVER["CONTEXT_DOCUMENT_ROOT"]."/examples/uploads/movie/";
...
$targ1="examples/uploads/movie/".basename($_FILES['thumbnail']['name']);
...
$query ="INSERT INTO movie(name, img) VALUES ( '".$name."','".$targ1."')";
	...
	$query =" UPDATE movie
SET  name = '". $name."', img= '". (($_FILES['thumbnail']['name']!="")?$targ1:$thumb1)."'
WHERE id = '". $_POST['id']."'";
	      mysqli_query($db, $query);
...
$sql = "DELETE FROM movie where id=".$_REQUEST['id'];
$result = $db->query($sql);
...
$sql = "SELECT * FROM movie where id=".$_REQUEST['id'];
$result = $db->query($sql);
...
<head>
  ...
  <title>
  Songs Details upload Dashboard 
  </title>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">ADD Movie Name</h2>
                </div>
                <div class="card-body">
                    <form enctype="multipart/form-data" action="#" method="POST"  >
                        ...
                        <div class="form-row">
                            <div class="name">Enter Movie Name</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text"  name="name" value="<?php echo (isset($coursedata['name'])) ? $coursedata['name'] : '';?>">
                                </div>
                            </div>
                        </div>
